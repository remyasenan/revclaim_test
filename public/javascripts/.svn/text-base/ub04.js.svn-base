...
function total_charge_adder() {
    if ($('incorrect') == null)
    {
        ...
        {
            alert("Total charges and the sum of service line charges does not match");
            $('ub04_claim_informations_total_charges').focus();
            $('ub04_claim_informations_total_charges').value = parseFloat(sum);
        }
        else
            return true
    }
       ...
       if (sum1.toFixed(2) != ((parseFloat($("ub04_claim_informations_total_charges").value)).toFixed(2)))
        {
            alert("Total charges and the sum of service line charges does not match");
            $('ub04_claim_informations_total_charges').focus();
            $('ub04_claim_informations_total_charges').value = parseFloat(sum1);
        }
        else
            return true
    }
...
function specialcharactercheck()
{
    ...
    {
        if ((document.form1.elements[i].value.match(issplchr)) && (document.form1.elements[i].name != 'batchid'))
        {
...
function addRow(id) {
    if ((service_line_blank_validator()) && (service_line_validator()) && (rev_code()) && hcpcs_prompt() && specialcharactercheck_svc()) {
        rowcount ++;
        count ++;
        count1 ++;
