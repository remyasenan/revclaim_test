...
class Occurence < ActiveRecord::Base
  ...
  def count_processor_input_ub04_occurence_fields()
    total_ub04_occurence_fields_with_data = 0
    ub04_occurence_fields = [code1, code2, code3, code4, date1, date2, date3, date4]

    ub04_occurence_fields_with_data = ub04_occurence_fields.select{|field| !field.blank? and field != '--'}

    total_ub04_occurence_fields_with_data = ub04_occurence_fields_with_data.length

    return total_ub04_occurence_fields_with_data
  end
