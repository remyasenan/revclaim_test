...
function formvalidator_completedclaim()
{
    ...
    if (flag == 1) {
        ...
        else if ((serviceLineValidations()) && (isPatientState()) && (isInsuredsState()) && (IS_patient_relationship()) && (Compare_Totalcharge_With_Chargessum()) && (payer_name()) && (payer_addrone()) && (payer_addrtwo()) && (payer_city()) && (payer_state()) && (payer_zipcode()) && (placeofservicecheckinocr()) && (isBillingOrganizationState()) && (isLastName()) && (isSuffix(facilityName)) && (isFirstName()) && (isInitial()) && (isAddress()) && (isCity()) && (isZipCode()) && (isTelePhone()) && (isInsuredsNumber()) && (isInsuredLastName()) && (isInsuredSuffix(facilityName)) && (isInsuredFirstName()) && (isInsuredInitial()) && (isInsuredsAddress()) && (isInsuredsCity()) && (isInsuredZipCode()) && (isautoAccidentPlace()) && (isInsuredsTelePhone()) && (isFECANumber(facilityName)) && isinsuranceplanname(facilityName) && (isEmpName()) && (isInusrancePlanName()) && (isSignedDOB()) && (isValidDate('current_month','current_date','current_year')) && (isValidDate('illness_month','illness_date','illness_year')) && (isReFPRVB()) && (is17a()) && (isRefPrvName()) && (isRefPrvName1(facilityName)) && (isRefPrvName2()) && (isRefPrvName3()) && (isDiaganosisInjury()) && (isDiaganosisInjury2()) && (isDiaganosisInjury3()) && (isDiaganosisInjury4()) && (isValidDate('occu_from_month','occu_from_date','occu_from_year')) && (isValidDate('occu_to_month','occu_to_date','occu_to_year')) && (isValidDate('service_from_month','service_from_date','service_from_year')) && (isValidDate('service_to_month','service_to_date','service_to_year')) && (isLabCharge()) && (isMediCode()) && (isOrginalRefNumber()) && (IsPriororganizationNumber()) && (isFederalTaxId()) && (isPatientAccountNumber()) && (isPhysicianLastName()) && (isPhysicianSuffix(facilityName)) && (isPhysicianFirstName()) && (isPhysicianInitial()) && (isPhyOrganizationName()) && (isPhySicianDOB()) && (isOrganizationName()) && (isOrganizationAddress()) && (isOrganizationCity()) && (isOrganizationState()) && (isOrganizationZipCode()) && (isOrganisationB()) && (isAmountPaid()) && (isBillingOrganizationName()) && (isBillingOrganizationAddress()) && (isBillingOrganizationCity()) && (isBillingOrganizationZipCode()) && (isBillingOrganisationTelePhone()) && (isBillOrganisationB()) && (isBillingProviderMiddle(facilityName)) && (IsDateofCurrent()) && (dateservicefrom1()) && (dateserviceTo()) && (emz()) && (isDiganosis_ServiceLine()) && (family1()) && (dayofunits()) && (isRenderingProviderNPI()) && (diagnosisorinjury_duplication()) && (compareDates_occupation()) && (compareDates_service()) && (npivalidation()) && (isDOB('patient_dob_month','patient_dob_date','patient_dob_year')) && (isDOB_nonmandatory('insured_dob_month','insured_dob_date','insured_dob_year')) && (isfromdateempty('occu_from_month','occu_from_date','occu_from_year','occu_to_month','occu_to_date','occu_to_year')) && (isfromdateempty('service_from_month','service_from_date','service_from_year','service_to_month','service_to_date','service_to_year')))
        {
            var agree = confirm("Are you sure you wish to continue?");
            if (agree == true)
                return true;
...
function Compare_Totalcharge_With_Chargessum() {
    ...
    for (k = 1; k <= 200;k++)
    {
        if (document.getElementById(k) != null) {
            if(document.getElementById(k).value != "")
                {
            charge_sum = charge_sum + parseFloat(document.getElementById(k).value)
                }
    ...
    {
        alert("Total Charge is not matching with service line charges");
        $('cms1500_total_charge').value = charge_round;
...
{
    if ($('placeofservice' + line).value == '')
    {
        alert("Place of service field cannot be blank");
        ($('placeofservice' + line)).focus();
        return false;
    }
    else if (($('placeofservice' + line).value != '') && ($('placeofservice' + line).value.match(placeofserviceregexp)))
    {
        return true;
    }
    else
...
function tot_charge_nonocr() {
    ...
    {
        alert("Total Charge is not matching with service line charges");
        $('cms1500_total_charge').value = total_charges;
        return false
    }
}
function idq()
...
function isDateofServiceToSpace() {
    alert(document.getElementById('dateofserviceto').value)
    if (document.getElementById('dateofserviceto').value == '')
        return true
...
function addRow(id) {
    ...
    if ((epstd11()) && (idq()) && (rend()) && (isRenderingProviderIdPresent()) && (emz()) && (isCPTCPCD()) && (charges1()) && (charges2()) && (family1()) && (dayofunits()) && (isDiganosis_ServiceLine()) && (placeofservicecheck()) && (nonocr_serviceline_npivalidation())) {
        rowcount ++;
        count ++;
        count1 ++;
...
function addServiceLine(id) {
    ...
    textField.setAttribute('id', "lineinformation_epsdt_" + rowcount + "")
    ...
    textField.setAttribute('id', "lineinformation_id_qual1_" + rowcount + "")
    textField.setAttribute('size', '4')
    textField.className = "black_text"
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_rendering_provider_id1_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    textField.setAttribute('size', '4')
    ...
    radioInput.onblur = function changeFocus() { elem = $('svc_edit_btn'); elem.focus(); }
    ...
    textField.setAttribute('id', "lineinformation_dateofservice_from_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_dateofservice_to_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_placeof_service_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_emg_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_cpthcpcs_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    td12.appendChild(textField)
    ...
    textField.setAttribute('id', "lineinformation_modifier1_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    td11.appendChild(textField)
    ...
    textField1.setAttribute('id', "lineinformation_modifier2_" + rowcount + "")
    ...
    textField2.setAttribute('id', "lineinformation_modifier3_" + rowcount + "")
    ...
    textField3.setAttribute('id', "lineinformation_modifier4_" + rowcount + "")
    ...
    textField.setAttribute('id', "lineinformation_diagnosis_pointer_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "charges_"+rowcount+"")
    ...
    textField.setAttribute('id', "lineinformation_days_or_units_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_minutes_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_epsdt_familycharge2_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_id_qual2_" + rowcount + "")
    textField.setAttribute('readOnly', true)
    ...
    textField.setAttribute('id', "lineinformation_rendering_provider_id2_" + rowcount + "")
    textField.setAttribute('readOnly', true)
...
{
    $('lineinformation_dateofservice_from_'+svcnum).className = "highlightevc";
    $('lineinformation_dateofservice_to_'+svcnum).className = "highlightevc";
    $('lineinformation_placeof_service_'+svcnum).className = "highlightevc";
    $('lineinformation_emg_'+svcnum).className = "highlightevc";
    $('lineinformation_cpthcpcs_'+svcnum).className = "highlightevc";
    $('lineinformation_modifier1_'+svcnum).className = "highlightevc";
    $('lineinformation_modifier2_'+svcnum).className = "highlightevc";
    $('lineinformation_modifier3_'+svcnum).className = "highlightevc";
    $('lineinformation_modifier4_'+svcnum).className = "highlightevc";
    $('lineinformation_diagnosis_pointer_'+svcnum).className = "highlightevc";
    $('charges_'+svcnum).className = "highlightevc";
    $('lineinformation_days_or_units_'+svcnum).className = "highlightevc";
    $('lineinformation_minutes_'+svcnum).className = "highlightevc";
    $('lineinformation_epsdt_familycharge2_'+svcnum).className = "highlightevc";
    $('lineinformation_id_qual2_'+svcnum).className = "highlightevc";
    $('lineinformation_rendering_provider_id2_'+svcnum).className = "highlightevc";
    $('lineinformation_epsdt_'+svcnum).className = "highlightevc";
    $('lineinformation_id_qual1_'+svcnum).className = "highlightevc";
    $('lineinformation_rendering_provider_id1_'+svcnum).className = "highlightevc";
}

function undohighlight(svcnum)
{
    $('lineinformation_dateofservice_from_'+svcnum).className = "black_text";
    $('lineinformation_dateofservice_to_'+svcnum).className = "black_text";
    $('lineinformation_placeof_service_'+svcnum).className = "black_text";
    $('lineinformation_emg_'+svcnum).className = "black_text";
    $('lineinformation_cpthcpcs_'+svcnum).className = "black_text";
    $('lineinformation_modifier1_'+svcnum).className = "black_text";
    $('lineinformation_modifier2_'+svcnum).className = "black_text";
    $('lineinformation_modifier3_'+svcnum).className = "black_text";
    $('lineinformation_modifier4_'+svcnum).className = "black_text";
    $('lineinformation_diagnosis_pointer_'+svcnum).className = "black_text";
    $('charges_'+svcnum).className = "amount";
    $('lineinformation_days_or_units_'+svcnum).className = "black_text";
    $('lineinformation_minutes_'+svcnum).className = "black_text";
    $('lineinformation_epsdt_familycharge2_'+svcnum).className = "black_text";
    $('lineinformation_id_qual2_'+svcnum).className = "black_text";
    $('lineinformation_rendering_provider_id2_'+svcnum).className = "black_text";
    $('lineinformation_epsdt_'+svcnum).className = "black_text";
    $('lineinformation_id_qual1_'+svcnum).className = "black_text";
    $('lineinformation_rendering_provider_id1_'+svcnum).className = "black_text";

}
 function unfreeze()
{
checked_radiobutton = $$('input:checked[type="radio"][name="radioInput"]').pluck('value');
checked_radio = checked_radiobutton[0]

    if(checked_radiobutton == '')
        alert("Please select a serviceline")
    else 
    {
        num = checked_radio.split("-")
        svc_num = num[1]
        $('lineinformation_dateofservice_from_'+svc_num).readOnly = false;
        $('lineinformation_dateofservice_to_'+svc_num).readOnly = false;
        $('lineinformation_placeof_service_'+svc_num).readOnly = false;
        $('lineinformation_emg_'+svc_num).readOnly = false;
        $('lineinformation_cpthcpcs_'+svc_num).readOnly = false;
        $('lineinformation_modifier1_'+svc_num).readOnly = false;
        $('lineinformation_modifier2_'+svc_num).readOnly = false;
        $('lineinformation_modifier3_'+svc_num).readOnly = false;
        $('lineinformation_modifier4_'+svc_num).readOnly = false;
        $('lineinformation_diagnosis_pointer_'+svc_num).readOnly = false;
        $('charges_'+svc_num).readOnly = false;
        $('lineinformation_days_or_units_'+svc_num).readOnly = false;
        $('lineinformation_minutes_'+svc_num).readOnly = false;
        $('lineinformation_epsdt_familycharge2_'+svc_num).readOnly = false;
        $('lineinformation_id_qual2_'+svc_num).readOnly = false;
        $('lineinformation_rendering_provider_id2_'+svc_num).readOnly = false;
        $('lineinformation_epsdt_'+svc_num).readOnly = false;
        $('lineinformation_id_qual1_'+svc_num).readOnly = false;
        $('lineinformation_rendering_provider_id1_'+svc_num).readOnly = false;
        disblebuttons()
        highlightsvc(svc_num)
        $('lineinformation_dateofservice_from_'+svc_num).focus()
    }
}

  function freeze(svc_num)
{
    $('lineinformation_dateofservice_from_'+svc_num).readOnly = true;
    $('lineinformation_dateofservice_to_'+svc_num).readOnly = true;
    $('lineinformation_placeof_service_'+svc_num).readOnly = true;
    $('lineinformation_emg_'+svc_num).readOnly = true;
    $('lineinformation_cpthcpcs_'+svc_num).readOnly = true;
    $('lineinformation_modifier1_'+svc_num).readOnly = true;
    $('lineinformation_modifier2_'+svc_num).readOnly = true;
    $('lineinformation_modifier3_'+svc_num).readOnly = true;
    $('lineinformation_modifier4_'+svc_num).readOnly = true;
    $('lineinformation_diagnosis_pointer_'+svc_num).readOnly = true;
    $('charges_'+svc_num).readOnly = true;
    $('lineinformation_days_or_units_'+svc_num).readOnly = true;
    $('lineinformation_minutes_'+svc_num).readOnly = true;
    $('lineinformation_epsdt_familycharge2_'+svc_num).readOnly = true;
    $('lineinformation_id_qual2_'+svc_num).readOnly = true;
    $('lineinformation_rendering_provider_id2_'+svc_num).readOnly = true;
    $('lineinformation_epsdt_'+svc_num).readOnly = true;
    $('lineinformation_id_qual1_'+svc_num).readOnly = true;
    $('lineinformation_rendering_provider_id1_'+svc_num).readOnly = true;
...
{
    if (($('lineinformation_epsdt_'+svc_num).value != '' ))
    {
        if (!($('lineinformation_epsdt_'+svc_num).value.match(string))) {
            alert('Epst must be a string')
            $('lineinformation_epsdt_'+svc_num).focus();
            return false
...
function idq_svc(svc_num)
{
    ...
    if (($('lineinformation_id_qual1_'+svc_num).value != ''))
    {
        if (($('lineinformation_id_qual1_'+svc_num).value.match(string))) {
            return true
        }
        else {
            alert('id_qua1 must be a string')
            $('lineinformation_id_qual1_'+svc_num).focus();
            return false
...
{
    if (($('lineinformation_rendering_provider_id1_'+svc_num).value != ''))
    {
        if (($('lineinformation_rendering_provider_id1_'+svc_num).value.match(string))) {
            return true
        }
        else {
            alert('rendering_provider1 must be a string')
            $('lineinformation_rendering_provider_id1_'+svc_num).focus();
            return false
        }
    }
    else
...
function isRenderingProviderIdPresent_svc(svc_num) {
    var id_q = $('lineinformation_id_qual1_'+svc_num).value
    var rend_prv_id = $('lineinformation_rendering_provider_id1_'+svc_num).value
    if (id_q != '')
    {
        if (rend_prv_id != '')
            return true
...
function dateservicefrom1_svc(svc_num)
{
    ...
    text_value = $('lineinformation_dateofservice_from_'+svc_num).value;
    year_array = text_value.split("/");
    if ($('lineinformation_dateofservice_from_'+svc_num).value != '' )
    {
        if (($('lineinformation_dateofservice_from_'+svc_num).value.match(dobRegxp))) {
            if (future_date($('lineinformation_dateofservice_from_'+svc_num).value))
            {
                 agreefuturedate = confirm("You entered a future date. Are you sure to continue?")
                if(agreefuturedate == true)
                    return true
                    ...
                    {
                        $('lineinformation_dateofservice_from_'+svc_num).focus()
                        $('lineinformation_dateofservice_from_'+svc_num).highlight()
                        return false
                    }
            }
...
{
    text_date_of_service_to = $('lineinformation_dateofservice_to_'+svc_num).value;
    date_of_service_to = text_date_of_service_to.split("/");
    if ($('lineinformation_dateofservice_to_'+svc_num).value != '')
    {
        if (($('lineinformation_dateofservice_to_'+svc_num).value.match(dobRegxp))) {
            if (future_date($('lineinformation_dateofservice_to_'+svc_num).value))
            {
                 agreefuturedate = confirm("You entered a future date. Are you sure to continue?")
                if(agreefuturedate == true)
                    return true
                    ...
                    {
                        $('lineinformation_dateofservice_to_'+svc_num).focus()
                        $('lineinformation_dateofservice_to_'+svc_num).highlight()
                        return false
                    }
            }
...
{
    var emz_y = $('lineinformation_emg_'+svc_num).value

    if (($('lineinformation_emg_'+svc_num).value.length != 0))
    {
        ...
        if ((emz_y == 'Y') || (emz_y == 'N')) {
            ...
            alert('EMG Y or N')
            $('lineinformation_emg_'+svc_num).focus();
            emz_y = ''
            return false
        }
...
function isCPTCPCD_svc(svc_num) {
    cptcode = $('lineinformation_cpthcpcs_'+svc_num).value
    cptcpcd_length = cptcode.length
    if ($('lineinformation_cpthcpcs_'+svc_num).value != '') {
        if (cptcode.match(string)) {
            ...
            if (cptcpcd_length == 5) {
                ...
                alert('CPT/HCPCS must be 5 digits')
                $('lineinformation_cpthcpcs_'+svc_num).focus()
                return false;
            }
...
{
    if (($('charges_'+svc_num).value != '' ))
    {
        if (($('charges_'+svc_num).value.match(float1)) || ($('charges_'+svc_num).value.match(numericExpression)))
        {
            return true
        }
        else {
            alert('charge is not a float number')
            $('charges_'+svc_num).focus();
            return false
        }
...
{
    var family_chrg = $('lineinformation_epsdt_familycharge2_'+svc_num).value
    if (family_chrg != '')
    {
        ...
        {
            alert('Family plan should be Y or N')
            $('lineinformation_epsdt_familycharge2_'+svc_num).focus();
            return false
        }
    }
    else
...
function dayofunits_svc(svc_num)
{
    ...
    if($('lineinformation_minutes_'+svc_num).value == ""){
        if (($('lineinformation_days_or_units_'+svc_num).value != '' ))
        {
            if (($('lineinformation_days_or_units_'+svc_num).value.match(float1)) || ($('lineinformation_days_or_units_'+svc_num).value.match(numericExpression)))
            {
                return true
            }
            else {
                alert(' Units must be a real number')
                $('lineinformation_days_or_units_'+svc_num).focus();
                return false
            }
        }
        else
...
function isDiganosis_ServiceLine_svc(svc_num) {
    if ($('lineinformation_diagnosis_pointer_'+svc_num).value != '') {
        if ($('lineinformation_diagnosis_pointer_'+svc_num).value.match(diagnosis_ptr)) {
            ...
            if (checkDiagonosis() == 0) {
                ...
                $('lineinformation_diagnosis_pointer_'+svc_num).focus();
                return true;
            }
        }
        else
...
{
    if (($('lineinformation_placeof_service_'+svc_num).value == '0') || ($('lineinformation_placeof_service_'+svc_num).value == ''))
    {
        ...
        {
            $('lineinformation_placeof_service_'+svc_num).focus();
            return false;
        }
    }
    else
        {
        if (!($('lineinformation_placeof_service_'+svc_num).value.match(placeofserviceregexp)))
                    {
                        alert("Place of service must be a 2 digit number or blank");
                        $('lineinformation_placeof_service_'+svc_num).focus();
                        return false;
...
{
    if ((isValidNPI($('lineinformation_rendering_provider_id2_'+svc_num).value)) == false)
    {
        $('lineinformation_rendering_provider_id2_'+svc_num).focus();
        return false;
    }
    return true;
}
...
function updateaddedservicelines()
{
    ...
    else
    {
        num = checked_radio.split("-")
        sline_no = num[1]
        if($('lineinformation_dateofservice_from_'+sline_no).readOnly == true)
        {
        ...
        {
            modifier1 = 'lineinformation_modifier1_'+sline_no
            modifier2 = 'lineinformation_modifier2_'+sline_no
            modifier3 = 'lineinformation_modifier3_'+sline_no
            modifier4 = 'lineinformation_modifier4_'+sline_no
...
function call1() {
    ...
    for (i = 1; i < count; i++)
    {
        s1 = parseFloat(s1) + parseFloat($('charges_'+i).value)
...
function isServiceLinePlaceOfservice() {
    ...
    for (l = 1; l <= 6; l++) {
        temp_value = document.getElementById('placeofservice' + l).value;
        if (temp_value != '') {
