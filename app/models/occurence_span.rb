...
class OccurenceSpan < ActiveRecord::Base
  ...
  def count_processor_input_ub04_occurence_span_fields()
    total_ub04_occurence_span_fields_with_data = 0
    ub04_occurence_span_fields = [code1, code2, from_date1, from_date2, through_date1, through_date2]

    ub04_occurence_span_fields_with_data = ub04_occurence_span_fields.select{|field| !field.blank? and field != '--'}

    total_ub04_occurence_span_fields_with_data = ub04_occurence_span_fields_with_data.length

    return total_ub04_occurence_span_fields_with_data
  end
